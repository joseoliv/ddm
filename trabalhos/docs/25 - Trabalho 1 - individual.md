...
https://github.com/joseoliv/ddm

Veja esta descrição em trabalhos/docs/25 - Trabalho 1 - individual.txt

Isto é, você deve fazer exemplos de widgets que estão no diretório lib/widgets. Dois deles já estão prontos, WImage e WAlign. 
...
No AVA, entreguem apenas um zip (não RAR, não outra coisa) com os diretórios 'assets' e 'lib'. Coloque o seu nome completo no nome do arquivo, sem acentos e sem espaços. 
